...
class MollieController extends Controller
{
    ...
    public function preparePayment(Order $order, Cart $cart)
    {
        $transaction = Mollie::api()->payments()->create([
            ...
            'cancelUrl' => ' https://ee03-81-165-217-186.ngrok-free.app/payment-cancel', // route('payment-cancel')
            'webhookUrl' => ' https://ee03-81-165-217-186.ngrok-free.app/api/mollie/webhook', // route('api/mollie/web')
            'method' => 'bancontact',
            'metadata' => [
                "order_id" => $order->id,
            ],
