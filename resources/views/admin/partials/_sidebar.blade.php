        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link " href="{{route('home')}}">
                    <div class="sb-nav-link-icon d-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
