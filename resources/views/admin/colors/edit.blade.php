...
@section('content')
    ...
    <div class="row">
        <form action="{{action("\App\Http\Controllers\ColorsController@update", $color)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="d-xl-flex col-xl-12">
                <div class="col-lg-9">
                    ...
                    <div class="row g-3 mb-9">
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary ms-2">Update Close</button>
                        </div>
                    </div>
                </div>
            </div>
