                ...
                <div class="col-lg-7">
                    ...
                    <div class="bg-white p-2 p-lg-3 mb-1">
                        ...
                        <fieldset class="mb-2">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="name" name="name" class="form-control" id="floatingInput" placeholder="your name...">
                        ...
                        <fieldset class="mb-2">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="address"  name="adress" class="form-control" id="floatingInput" placeholder="Straat , Nr.">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="bus" name="bus"  class="form-control" id="floatingInput" placeholder="Bus (optionel)">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="postcode" name="postcode" class="form-control" id="floatingInput" placeholder="Vorbield: 8930 ">
                        ...
                        <fieldset class="mb-2">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="city" name="city"  class="form-control" id="floatingInput" placeholder="Stad">
                    ...
                    <div class="bg-white p-2 p-lg-3 mb-1">
                        ...
                        <div class="custom-control custom-choice">
                            <input type="radio" name="delivery" class="custom-control-input" id="custom-choice-1">
                ...
                <aside class="col-lg-5">
                            ...
                            @foreach ($cart->content() as $cartItem)
                                <div class="row align-items-center">
                                    <div class="col-2">
                                        ...
                                        <a href="{{ route('products.show', $cartItem->product()->id) }}">
                                            @if($cartItem->product()->photos->first())
                                                <img class="img-fluid" src="{{ $cartItem->product()->photos->first()->file}}" alt="...">
                                            @else
                                    ...
                                    <div class="col-2 d-flex flex-column">
                                        <!--Footer -->
                                        <form action="{{ route('cart.update',['productId' => $cartItem->product()->id]) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <div class="d-flex flex-column justify-content-between align-items-center">
                                                <!-- Select -->
                                                <input type="number" value="{{ $cartItem->quantity() }}" name="quantity_{{$cartItem->product()->id}}" class="form-control" />
                                            </div>
                                    ...
                                    <div class="col-2">
                                        <strong>Subtotal</strong> <strong class="ms-auto">&euro;{{ $cartItem->total() }}</strong>
                                    </div>
                                    <div class="col-1">
                                        <!-- Remove -->
                    ...
                    <ul class="list-group list-group-minimal">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center text-red">
                                Taxes
                                <span class="text-red">&euro;{{ $cart->taxes() }}</span>
                            </li>
