...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        $products = [
            ...
            [
                'name' => 'Bracelet',
                'description' => 'Elegant bracelet to accessorize your outfit.',
                'price' => 19.99,
                'rating' => rand(1, 5),
                'quantity' => rand(1, 100),
            ],
            ...
            [
                'name' => 'Earrings',
                'description' => 'Beautiful earrings for a touch of elegance.',
                'price' => 14.99,
                'rating' => rand(1, 5),
                'quantity' => rand(1, 100),
            ],
            [
                'name' => 'Pulseira',
                'description' => 'Pulseira elegante para complementar seu visual.',
                'price' => 9.99,
                'rating' => rand(1, 5),
                'quantity' => rand(1, 100),
            ],
            ...
            [
                'name' => 'Notebook',
                'description' => 'Sleek and powerful notebook for work and entertainment.',
                'price' => 899.99,
                'rating' => rand(1, 5),
                'quantity' => rand(1, 100),
            ],
